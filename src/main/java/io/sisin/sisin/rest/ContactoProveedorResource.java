...
@RestController
@RequestMapping(value = "/api/contactoProveedor", produces = MediaType.APPLICATION_JSON_VALUE)
public class ContactoProveedorResource {
    ...
    @GetMapping
    public ResponseEntity<List<ContactoProveedorDTO>> getAllContactoProveedor() {
